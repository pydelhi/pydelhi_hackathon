...
# Please put your GCP API credential JSON details in creds.json to the application folder file.
# You can very well checn the file name with your file as well.
# This is mandatory to have connection to your GCP Vision API connection.
from oauth2client.client import GoogleCredentials
apppath = os.path.abspath(os.path.dirname(__file__))
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = apppath+'/creds.json'
